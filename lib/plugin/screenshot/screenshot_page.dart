...
class _ScreenshotPageState extends State<ScreenshotPage> {
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            textButtonStandard("页面部件", () => _controller1.capture().then((value) => _showDialog(value))),
            textButtonStandard("未展示的部件", () => _controller2.captureFromWidget(_getContainer()).then((value) => _showDialog(value))),
          ],
        )
      ],
    );
  ...
  void _showDialog(Uint8List? data) {
    showDialog(
      context: context,
      builder: (context) {
        return Dialog(
