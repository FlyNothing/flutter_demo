...
class ImageGallerySaverPage extends StatefulWidget {
  const ImageGallerySaverPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _ImageGallerySaverPageState();
}
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            textButtonStandard("保存到相册", () => _saveToGallery(_controller.text)),
            textButtonStandard("查看相册", () => _pickImage()),
          ],
        )
      ],
    );
